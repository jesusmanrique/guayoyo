    ...
    <section className="max-w-4xl py-6 mx-auto px-4 min-h-[60vh] pt-28">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <article className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 shadow-lg">
          ...
          <p className="text-white mb-2">Conoce los beneficios clave de la automatización y cómo puede transformar la productividad de tu empresa.</p>
        ...
        <article className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 shadow-lg">
          ...
          <p className="text-white mb-2">Historias reales de empresas que han implementado IA y han logrado resultados sorprendentes.</p>
          <a href="#" className="text-info underline">Leer más</a>
        </article>
        <article className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-white mb-2">Automatiza tu WhatsApp: Guía paso a paso</h2>
          <p className="text-white mb-2">Aprende cómo puedes automatizar la atención al cliente en WhatsApp y mejorar la experiencia de tus usuarios.</p>
          <a href="#" className="text-info underline">Leer más</a>
        </article>
        <article className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-white mb-2">Tendencias tecnológicas para PYMES en 2024</h2>
          <p className="text-white mb-2">Descubre las herramientas y tecnologías que marcarán la diferencia para las pequeñas y medianas empresas este año.</p>
          <a href="#" className="text-info underline">Leer más</a>
        </article>
      </div>
    </section>
