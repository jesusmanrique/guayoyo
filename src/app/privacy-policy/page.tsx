...
function Skeleton() {
  return (
    <section className="max-w-3xl mx-auto py-16 px-4 min-h-[60vh] flex flex-col items-center animate-pulse pt-28">
...
function PrivacyPolicyContent() {
  return (
    <div className="pt-32">
      <section className="max-w-3xl mx-auto px-4 py-10 mb-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl flex flex-col items-center animate-fade-in-up">
